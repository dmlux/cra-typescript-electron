...
const electronPath = 'src/electron';
...
if (
  ...
  module.exports = {
    ...
    appIndexJs: resolveOwn(`template/${appPath}/index.tsx`),
    appPackageJson: resolveOwn('package.json'),
    appSrc: resolveOwn(`template/${appPath}`),
    yarnLockFile: resolveOwn('template/yarn.lock'),
    testsSetup: resolveOwn(`template/${appPath}/setupTests.ts`),
    appNodeModules: resolveOwn('node_modules'),
    appTsConfig: resolveOwn('template/tsconfig.react.json'),
